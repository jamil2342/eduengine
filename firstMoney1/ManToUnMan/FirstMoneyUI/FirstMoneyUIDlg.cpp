...
// FirstMoneyUIDlg.cpp : implementation file
//
...
CFirstMoneyUIDlg::CFirstMoneyUIDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CFirstMoneyUIDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CFirstMoneyUIDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CFirstMoneyUIDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CFirstMoneyUIDlg message handlers

BOOL CFirstMoneyUIDlg::OnInitDialog()
{
...
void CFirstMoneyUIDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CFirstMoneyUIDlg::OnQueryDragIcon()
{
